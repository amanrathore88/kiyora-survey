...
export default function AdminDashboard() {
  ...
  const handleExport = () => {
    ...
    link.setAttribute('download', 'kiyora-survey-responses.csv');
      ...
      <main className="max-w-7xl mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
          ...
          <button
            ...
            className="w-full sm:w-auto px-4 py-2.5 bg-[#1b2a4a] hover:bg-[#2a3f6a] text-white text-xs sm:text-sm font-semibold rounded-xl transition shadow-xs flex items-center justify-center gap-2 cursor-pointer"
          >
