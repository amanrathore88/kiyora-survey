...
async function autoSeed() {
  ...
  const questionsData = [
    ...
    { sectionId: sec["D"], questionNumber: "Q17", orderIndex: 17, questionText: "What is your FIRST reaction to the ₹11,999 price?", questionType: "radio" as const, options: ["Very good value", "Reasonable / acceptable", "Slightly expensive but I may consider it", "Too expensive", "Not sure without comparing performance and filter cost"] },
    { sectionId: sec["D"], questionNumber: "Q18", orderIndex: 18, questionText: "What would you need to believe or verify before paying ₹11,999? (Select up to 3)", questionType: "checkbox" as const, maxSelections: 3, hasOtherOption: true, options: ["Proven CADR / cleaning performance", "Effective for severe Indian pollution", "Filter life and replacement cost", "Independent testing / certification", "Warranty & after-sales support", "Low noise", "Low electricity consumption", "Trusted technology / engineering credentials", "Customer reviews"] },
    { sectionId: sec["E"], questionNumber: "Q19", orderIndex: 19, questionText: "After learning about the Japanese technology / design association, does your interest change?", questionType: "radio" as const, options: ["Much more interested", "Somewhat more interested", "No change", "Somewhat less interested", "Much less interested"] },
